...
const About = () => (
  <Layout>
    ...
    <div className={styles.block}>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>Front-End Software Engineer Intern (2019.12 ~ 2020.02)</li>
            <li>Front-End Software Engineer (2020.07 ~ Present)</li>
          </ul>
        </li>
      </ul>
    </div>
    ...
    <div className={styles.block}>
      ...
      <a
        href="https://www.instagram.com/niceb5y"
        className={styles.button}
        role="button"
      >
        Instagram
    ...
    <div className={styles.block}>
      <h1>Et cetera</h1>
      <a
        href="https://moments.seungho.kim"
        className={styles.button}
        role="button"
      >
        Moments
